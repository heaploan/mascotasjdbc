...
CREATE TABLE `perro` (
  ...
  CONSTRAINT `fk_propietario` FOREIGN KEY (`propietario`) REFERENCES `propietario` (`nombre`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2024-05-03 18:47:08
